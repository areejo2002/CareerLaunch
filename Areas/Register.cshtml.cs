...
namespace CareerLaunchpad.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                // تسجيل الخطأ (يمكنك تعديل هذه الرسالة)
                _logger.LogError(ex, "SqlNullValueException occurred while creating user.");
                ModelState.AddModelError(string.Empty, "حدث خطأ في البيانات المدخلة. يرجى التأكد من ملء جميع الحقول المطلوبة.");
                return Page();
            }
            catch (Exception ex)
            {
                ...
                ModelState.AddModelError(string.Empty, "حدث خطأ غير متوقع. حاول مرة أخرى لاحقًا.");
                return Page();
            }
        }
    }
